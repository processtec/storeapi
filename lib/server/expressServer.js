...
const pubIP = config.get('SERVER.IP');
const pubPathCors = "http://"+pubIP + ":9000";
...
const imagesDir = path.normalize(path.join(__dirname, PUBLIC_PATH)); //path.join(__dirname, 'public');
let server;
