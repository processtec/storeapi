...
const report = require("../useCases/report/reportController");
...
const register = (options) => {
  ...
  // stock & product
  router.get(
    "/stock/component/:stockId/:cmpId",
    stock.getProductsByComponentAndStock
  );
  ...
  router.put(
    "/report/cart/shipment/:id",
    report.modifyCartShipmentReportDetails
  );
};
