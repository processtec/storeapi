...
//TODO: I doubt we need this route as when we add a product we take care of adding stock 
const addComponents = async (options) => {
    ...
    try {
        ...
        const sql = connection.format('INSERT INTO store.stock (idcmp, mfgmodelnumber) VALUES ?', options.sanitizedComponents);
